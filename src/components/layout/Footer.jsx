        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-[#25D366] group-hover/phone:bg-[#25D366] group-hover/phone:text-white transition-colors">
                  <svg
